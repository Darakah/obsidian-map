<script>
    ...
    $: Object.values(selected).map((o) => {
        types.update((e) => Object.values(selected).map((o) => o.value));
    })
...
<b style="margin-left:10px;" width="15%"> Types </b>
<br />

<div
    style="width=50px !important; margin-left: 20px; border-radius: 14px !important;"
>
    <div
        class="multiselect"
        class:readonly
        style="border-radius: 14px; margin-right: 5px; padding-bottom: 5px;"
    >
        <div
            class="tokens"
            class:showOptions
